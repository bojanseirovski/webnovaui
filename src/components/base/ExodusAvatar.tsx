...
import avatar from 'assets/img/team/avatar-placeholder.webp';
...
export const ExodusAvatarGroup = ({
  children,
  className,
  total,
  size
  ...
  return (
    <div className={classNames(className, 'avatar-group')}>
      ...
      {total && total > Children.count(children) && (
        <ExodusAvatar size={size} variant="name">
...
ExodusAvatar.Group = ExodusAvatarGroup;

export default ExodusAvatar;
